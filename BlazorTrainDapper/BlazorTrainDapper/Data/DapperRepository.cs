//DapperRepository.cs
//Because we have defined IRepository to support generics, we can create a repository for Dapper
//that will work with any SQL Database and any Table.
//On top of that, it's flexible enough to handle the three PKey types:
//Int, Non-Identity
//Int, Identity
//String

namespace BlazorTrainDapper.Data
{
