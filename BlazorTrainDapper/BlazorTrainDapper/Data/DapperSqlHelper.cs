//The Dapper-specific generic repository we are about to create uses a class that I built to generate an insert
//statement when the PKey is a string - DapperSqlHelper.cs:
